...
public class Main {
    public static void main(String[] args) {
        ...
        DES encryptionExample3 = new DES("TESTTESTTT",    "TESTTEST"         ,false);
        String cipherText3 = encryptionExample3.encrypt();
        encryptionExample3.printEncryption(cipherText3);

        DES decryptionExample3 = new DES("0001001100110100010101110111100110011011101111001101111111110001", "00010011001101000101011101111001100110111011110011011111111100011",false);
